...
for i in data["Registration"].unique():
    ...
    #pdf.perct(i)
    i=str(i)
    pdf.fig1(r"fig\."+i+"_bar.png",percentile)
    pdf.fig2(r"fig\."+i+"_pie1.png")
    pdf.add_page()
    pdf.fig3(r"fig\."+i+"_pie2.png")
    pdf.fig4(r"fig\."+i+"_pie3.png")
    pdf.fig5(r"fig\."+i+"_pie4.png")
    P_image=int(P_image)    
    pdf.output(r"product\."+i+".pdf", "F")
    plt.close()